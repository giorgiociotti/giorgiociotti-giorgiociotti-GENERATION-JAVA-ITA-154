...
public class Esercizio16 {
    public static void main(String[] args) {
        ...
        System.out.print("Sei insegnante o studente d'arte? (si/no): ");
        String arteInput = scanner.next();
        boolean isArte = arteInput.equalsIgnoreCase("si");
        ...
        if (!fasciaNormale && !fasciaSerale) {
            ...
            if (fasciaSerale && isArte) {
                prezzo = 0;
                notaPrezzo = "Ingresso libero per ragioni di studio";
            } else {
                prezzo = (eta > 65 || eta < 12) ? 5 : 10;
                if (fasciaSerale) prezzo += 2;
                notaPrezzo = prezzo + " euro" + (fasciaSerale ? " (+2€ serale)" : "");
            }
            System.out.println(" Nome:   " + nome);
            System.out.println(" Data:   " + data);
            System.out.println(" Ora:    " + ora + ":00");
            System.out.println(" Prezzo: " + notaPrezzo);
        }
    }
}