...
public class Esercizio19 {
    public static void main(String[] args) {
        ...
        System.out.print("Vuoi aggiungere un'assicurazione sul viaggio? (si/no): ");
        String assicurazioneInput = scanner.next();
        boolean conAssicurazione = assicurazioneInput.equalsIgnoreCase("si");
        ...
        double costoAssicurazione = conAssicurazione ? costoTotale * 0.05 : 0;
        double costoFinale        = costoTotale + costoAssicurazione;
        ...
        if (conAssicurazione) {
            System.out.printf("| Assicurazione (5%%): %-15.2f € |%n", costoAssicurazione);
        }
        
        System.out.printf("| TOTALE VACANZA:     %-15.2f € |%n", costoFinale);
    }
}